...
import {ExtractAllUsers} from '../../controllers/ctrl.ShiftUser';

const getAllEmployeesRequest = () => ({
...
const getAllEmployeesError = error => ({
...
* @param {string} sapId Employee's sap Id
*/
export const getAllEmployees = sapId => async dispatch => {
    try {
        ...
        if (employees) {
            ...
            dispatch(getAllEmployeesSuccess([]));
        }
    } catch (e) {
        dispatch(getAllEmployeesError(e));
    }  
};
